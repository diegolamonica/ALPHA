 ...
 * @var integer
 */
_define('AUTHENTICATION_ERROR_OK',						0);
/**
 * Costante di autenticazione che indica un errore nel nome utente o nella password indicati in fase di login
 * @var integer
 */
_define('AUTHENTICATION_ERROR_WRONG_USER_OR_PASSWORD',	1);
/**
 * Costante di autenticazione che indica un errore nel token presente in sessione
 * @var integer
 */
_define('AUTHENTICATION_ERROR_INVALID_TOKEN',			2);
/**
 * Costante di autenticazione che indica un errore nell'id mantenuto in sessione
 * @var integer
 */
_define('AUTHENTICATION_ERROR_INVALID_KEY',				4);

_define('AUTHENTICATION_ERROR_LDAP_SERVER_UNAVAILABLE',	8);

_define('AUTHENTICATION_ERROR_LDAP_NO_SEARCH_RESULTS',	16);

_define('AUTHENTICATION_ERROR_WRONG_PASSWORD',			32);
_define('AUTHENTICATION_ERROR_WRONG_USER',				64);

_define('AUTHENTICATION_ERROR_XS_NO_RECORD_FOUND',		128);
